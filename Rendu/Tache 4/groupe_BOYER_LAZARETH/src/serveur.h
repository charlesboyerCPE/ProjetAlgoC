 ...
 *  La fonction traite les opérations : addition, soustraction,
 *  multiplication, division, écart-type, la moyenne et trouver
 *  le minimum/maximum
 * 
 * \param [in] json : Le JSON avec le message
 * 
 * \return le résultat de l'opération, -1 si une erreur
 */
 ...
 *      Cette fonction sauvegarde les éléments recu dans un fichier
 *      "couleurs.txt"
 * \param [in] json : Le JSON avec le message
 * 
